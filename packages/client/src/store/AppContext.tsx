...
interface AppContextValue {
    ...
    updateColumnConfig: (boardId: string, columnId: string, data: { agentType: AgentType; maxAgents?: number; onFinishColumnId?: string | null; onRejectColumnId?: string | null }) => Promise<void>;
