...
export const boardRepository = {
    ...
    create(name: string, workspaces: Omit<BoardWorkspace, 'id' | 'board_id'>[] = []): Board {
    ...
    update(id: string, name: string, workspaces?: Omit<BoardWorkspace, 'id' | 'board_id'>[]): Board | undefined {
        const db = getDb();
